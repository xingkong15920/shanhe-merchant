...
var config = {
	...
	colors: ['#FFA20A', '#f7a35c', '#434348', '#90ed7d', '#f15c80', '#8085e9'],
...
function drawXAxis(categories, opts, config, context) {
	...
	context.beginPath();
	context.setStrokeStyle(opts.xAxis.gridColor || "rgba(198,198,198,1)");
...
function drawYAxisGrid(opts, config, context) {
	...
	context.beginPath();
	context.setStrokeStyle(opts.yAxis.gridColor || "rgba(198,198,198,1)");
	context.setLineWidth(1);
	points.forEach(function (item, index) {
...
function drawRadarDataPoints(series, opts, config, context) {
	...
	context.beginPath();
	context.setLineWidth(1);
	context.setStrokeStyle(radarOption.gridColor || "rgba(198,198,198,1)");
